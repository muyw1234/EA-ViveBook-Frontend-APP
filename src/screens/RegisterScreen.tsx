...
export default function RegisterScreen() {
  ...
  return (
    <LinearGradient colors={['#F5E4F0', '#F5E4F0']} style={globalStyles.gradient}>
        ...
        <View style={globalStyles.card}>
          ...
          <TextInput
            ...
            right={
              <TextInput.Icon
                icon={() => (
                  <RNText style={{ fontSize: 20 }}>{showConfirmPassword ? '👁️' : '👀'}</RNText>
                )}
          ...
          <Button onPress={() => navigation.navigate('Login' as never)} textColor="#D183BA">
