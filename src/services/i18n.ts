...
const resources = {
  es: {
    translation: {
      ...
      delete_temp_confirm: "¿Seguro que quieres activar el Modo vacaciones? Sirve para ocultar tu perfil temporalmente. Podrás volver a mostrarlo en cualquier momento iniciando sesión de nuevo.",
  ...
  ca: {
    translation: {
      ...
      delete_temp_confirm: "Segur que vols activar el Mode vacances? Serveix per amagar el teu perfil temporalment. Podràs tornar a mostrar-lo en qualsevol moment iniciant sessió de nou.",
  ...
  en: {
    translation: {
      ...
      delete_temp_confirm: "Are you sure you want to enable Vacation mode? This serves to hide your profile temporarily. You can show it again at any time by logging back in.",
